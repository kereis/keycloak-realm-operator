...
// Code generated by C:\Users\reis\go\bin\operator-sdk.exe. DO NOT EDIT.
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentExportRepresentation) DeepCopyInto(out *ComponentExportRepresentation) {
	*out = *in
	if in.Config != nil {
		in, out := &in.Config, &out.Config
		*out = make(map[string][]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentExportRepresentation.
func (in *ComponentExportRepresentation) DeepCopy() *ComponentExportRepresentation {
	if in == nil {
		return nil
	}
	out := new(ComponentExportRepresentation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ComponentExportRepresentationArray) DeepCopyInto(out *ComponentExportRepresentationArray) {
	{
		in := &in
		*out = make(ComponentExportRepresentationArray, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentExportRepresentationArray.
func (in ComponentExportRepresentationArray) DeepCopy() ComponentExportRepresentationArray {
	if in == nil {
		return nil
	}
	out := new(ComponentExportRepresentationArray)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *KeycloakAPIRealm) DeepCopyInto(out *KeycloakAPIRealm) {
	*out = *in
	...
	in.ClientProfiles.DeepCopyInto(&out.ClientProfiles)
	in.ClientPolicies.DeepCopyInto(&out.ClientPolicies)
	if in.RequiredActions != nil {
		in, out := &in.RequiredActions, &out.RequiredActions
		*out = make([]RequiredActionProviderRepresentation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Components != nil {
		...
		*out = make(map[string]ComponentExportRepresentationArray, len(*in))
		for key, val := range *in {
			var outVal []ComponentExportRepresentation
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RequiredActionProviderRepresentation) DeepCopyInto(out *RequiredActionProviderRepresentation) {
	*out = *in
	if in.Config != nil {
		in, out := &in.Config, &out.Config
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequiredActionProviderRepresentation.
func (in *RequiredActionProviderRepresentation) DeepCopy() *RequiredActionProviderRepresentation {
	if in == nil {
		return nil
	}
	out := new(RequiredActionProviderRepresentation)
	in.DeepCopyInto(out)
	return out
}
